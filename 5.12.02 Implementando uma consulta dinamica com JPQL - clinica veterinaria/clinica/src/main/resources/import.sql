insert into cuidador_animal (id, nome, idade, telefone, endereco) values (1, 'Bruno Afonso', 28, '11944445555', 'rua xxx');
insert into cuidador_animal (id, nome, idade, telefone, endereco) values (2, 'Jeferson Ribeiro', 30, '11977778888', 'rua yyy');
insert into cuidador_animal (id, nome, idade, telefone, endereco) values (3, 'Viviane', 51, '11922223333','rua zzz');
